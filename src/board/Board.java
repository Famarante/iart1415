...
public class Board {
	...
	public void init(){
		Node a1 = new Node("L","a1");
		Node a2 = new Node("B","a2");
		Node a3 = new Node("B","a3");
		Node a4 = new Node("B","a4");
		Node a5 = new Node("B","a5");
		Node b1 = new Node("B","b1");
		Node b2 = new Node("B","b2");
		Node b3 = new Node("E","b3");
		Node b4 = new Node("E","b4");
		Node b5 = new Node("E","b5");
		Node b6 = new Node("E","b6");
		Node c1 = new Node("B","c1");
		Node c2 = new Node("E","c2");
		Node c3 = new Node("E","c3");
		Node c4 = new Node("E","c4");
		Node c5 = new Node("E","c5");
		Node c6 = new Node("E","c6");
		Node c7 = new Node("E","c7");
		Node d1 = new Node("B","d1");
		Node d2 = new Node("E","d2");
		Node d3 = new Node("E","d3");
		Node d4 = new Node("E","d4");
		Node d5 = new Node("E","d5");
		Node d6 = new Node("E","d6");
		Node d7 = new Node("E","d7");
		Node d8 = new Node("E","d8");
		Node e1 = new Node("B","e1");
		Node e2 = new Node("E","e2");
		Node e3 = new Node("E","e3");
		Node e4 = new Node("E","e4");
		Node e5 = new Node("E","e5");
		Node e6 = new Node("E","e6");
		Node e7 = new Node("E","e7");
		Node e8 = new Node("E","e8");
		Node e9 = new Node("R","e9");
		Node f2 = new Node("E","f2");
		Node f3 = new Node("E","f3");
		Node f4 = new Node("E","f4");
		Node f5 = new Node("E","f5");
		Node f6 = new Node("E","f6");
		Node f7 = new Node("E","f7");
		Node f8 = new Node("E","f8");
		Node f9 = new Node("R","f9");
		Node g3 = new Node("E","g3");
		Node g4 = new Node("E","g4");
		Node g5 = new Node("E","g5");
		Node g6 = new Node("E","g6");
		Node g7 = new Node("E","g7");
		Node g8 = new Node("E","g8");
		Node g9 = new Node("R","g9");
		Node h4 = new Node("E","h4");
		Node h5 = new Node("E","h5");
		Node h6 = new Node("E","h6");
		Node h7 = new Node("E","h7");
		Node h8 = new Node("R","h8");
		Node h9 = new Node("R","h9");
		Node i5 = new Node("R","i5");
		Node i6 = new Node("R","i6");
		Node i7 = new Node("R","i7");
		Node i8 = new Node("R","i8");
		Node i9 = new Node("W","i9");
